...
class TransferirView:
    ...
    def build(self):
        ...
        self.txt_usuario_destino = ft.TextField(
        ...
        self.btn_transferir = ft.ElevatedButton(
            text="Transferir",
            width=400,
            height=55,
    ...
    def realizar_transferencia(self, e):
        ...
        usuario_destino = self.txt_usuario_destino.value
        
        if not usuario_destino or not self.txt_monto.value:
        ...
        resultado = self.transacciones.transferir(
            usuario_origen_id=self.usuario_data['id'],
        ...
        if resultado["exito"]:
            ...
            self.txt_usuario_destino.value = ""
